...
var KB=[
 ...
 {t:'When does it start? Dates & timing', k:'when start date dates begin beginning kab schedule time timing timings day sunday month monthly august 30 session calendar',
  a:'<p>The founding batch began on <b>Sunday, 30 August 2026</b> and runs as <b>one Sunday a month, 10:00 am – 1:00 pm</b>, followed by lunch: 12 monthly modules plus a convocation. A doctor joining now sits Module 1 with the next batch, so nothing is missed.</p>',
  c:[['See all twelve dates','/schedule']]},
 ...
 {t:'How do I enrol?', k:'enrol enroll register registration apply application book booking reserve seat sign signup admission process steps how',
  a:'<p>Complete the short application at <b>caspianobesity.com/apply</b> and pay the ₹2,999 founding fee securely online. Your seat is confirmed the moment payment is received. Enrolment is open, and a doctor who joins after a module has run sits that module with the next batch.</p>',
 ...
 {t:'Is there a deadline?', k:'deadline last date closing close cutoff cut off latest till until how long left hurry',
  a:'<p>There’s no fixed last date, and there is <b>no seat cap</b>. Enrolment for the founding batch is open now. Seats are reserved on payment, and a doctor who joins after a module has run sits that module with the next batch.</p>',
 ...
 {t:'Attendance rules', k:'attendance attend miss missed absent absence skip travel busy make up makeup recording recordings 80 percent minimum',
  a:'<p>You need to attend at least <b>80% of the live modules</b> (10 of 12) in person. <b>Sessions are not recorded.</b> If you miss one (up to two), you keep your place by sitting that module with the next batch and completing its assessment. Miss more than two and we’ll help you defer the outstanding modules to the next cohort.</p>'},
 ...
 {t:'The textbook', k:'textbook book books material materials notes study reading obesity medicine indian practice appendix appendices formulary handouts',
  ...
  c:[['Read a sample chapter (PDF)','/sample-chapter.pdf']]},
 {t:'Is it online? Are sessions recorded?', k:'online zoom virtual remote hybrid stream streaming video recorded recording distance outside other city state travel',
  a:'<p>The course is <b>in person, in Hyderabad</b>, and that’s deliberate: it’s case-based and hands-on. <b>Sessions are not recorded.</b> A module you miss is sat with the next batch. If you’re travelling from outside Hyderabad, it’s one Sunday a month.</p>'},
 {t:'Who teaches it?', k:'teacher teaches faculty director instructor trainer khizer junaidy who conduct conducting speaker',
  a:'<p>The course is directed and taught by <b>Dr Khizer Hussain Junaidy, MD</b>, Diabetologist and Bariatric Physician, with an MD in Pharmacology, a Fellowship in Diabetes, and SCOPE Certification from the World Obesity Federation. He has delivered 200+ invited talks and CMEs, and wrote the course textbook.</p>',
 ...
 {t:'Sponsorship & independence', k:'sponsor sponsorship pharma pharmaceutical company funded funding independent bias conflict interest',
  a:'<p>The course is funded entirely by participants’ tuition, with <b>no pharmaceutical or commercial sponsorship</b> of content, faculty or assessment. Every recommendation is taught on the evidence.</p>'},
 ...
 {t:'Promo codes', k:'promo code coupon discount voucher complimentary free invite',
  a:'<p>If you have a promo code, enter it at the final step of the application, and it’s applied at checkout. Codes are single-use.</p>',
 ...
 {t:'Seats & batch size', k:'seats seat batch size cohort many people group full sold left remaining available',
  a:'<p>There is <b>no seat cap</b>. The hall seats 100 and every doctor who enrols is taken, so the question is never whether a seat is left. Seats are confirmed on payment. The number enrolled so far is shown on the course home page.</p>',
  c:[['Ask about the batch','WA:Hi, I would like to know more about the CASPIAN Certificate in Obesity Medicine founding batch.']]},
 ...
 {t:'Do I need prior training?', k:'prior training experience beginner new start background prerequisite needed require first fresher',
  a:'<p>No. The course starts from the science and builds up to prescribing and running a practice, and no prior obesity-medicine training is expected. If you already treat diabetes, you’ll move quickly.</p>'},
...
function noMatch(qtext){
  ...
  b.innerHTML='<div class="cx-t">Let’s get you a proper answer</div>'+
    '<p>I answer from the official course information, and that one’s outside what I have. Send it to the team, and a human replies, usually within a working day.</p>'+
...
function build(){
  ...
  panel.innerHTML=
   ...
   '<div class="cx-note">Answers come from the official course information. Nothing you type here leaves your browser, and anything unanswered goes to WhatsApp, where a human replies.</div>';
